(function(){
    ...
    async function agregarTarea(tarea){
        ...
        try{
            const url = 'http://localhost:8300/api/tarea';
            const respuesta = await fetch(url,{
                method: 'POST',
                body: datos
            });
    ...
    async function actualizarTarea(tarea){
        ...
        //Esto es para saber cuales son los datos del nuevo FormDate
        // for(let valor of datos.values()) {
        //     console.log(valor);
        // }

        try {
            const url = 'http://localhost:8300/api/tarea/actualizar';
    ...
    async function eliminarTarea (tarea){
        ...
        try {
            const url = 'http://localhost:8300/api/tarea/eliminar';
            const respuesta = await fetch(url, {
                method: 'POST',
                body: datos
            });
